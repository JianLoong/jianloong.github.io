...
## Interactive VADER Demo

Try the interactive demo below! This React component demonstrates VADER sentiment analysis in action:

<VaderSentimentIsland client:only />
...
For the project page, please go [here](https://pangrammer.dev/sentimentanalysis)
