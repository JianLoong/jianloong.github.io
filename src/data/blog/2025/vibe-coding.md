...
- Migrated old blog from Hugo to Astro
- Removed some janky jQuery components to at least so called modern JavaScript
- Fixed up Janky word cloud implementation from 2019 or even older
- Fixed up janky implementation of various things (For example) using a lot of innerHTMLs and etc
- Fixed up heaps of things that was never meant to be working into the state of working
- Bang out more features other than the default Astro Paper by vibe coding it.
