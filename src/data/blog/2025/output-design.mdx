...
import {
  ...
  scatteredExternalCalls,
  cleanBusinessLogic,
  outpostPattern,
  outboxPattern
} from '../../../data/diagrams/output-design';
...
<MermaidDiagram client:load
  chart={scatteredExternalCalls}
  title="Scattered External Calls"
  align="center"
  size="full"
/>
...
<MermaidDiagram client:load
  chart={cleanBusinessLogic}
  title="Clean Business Logic"
  align="center"
  size="full"
/>
...
<MermaidDiagram client:load
  chart={outpostPattern}
  title="Outpost Pattern"
  align="center"
  size="md"
/>
